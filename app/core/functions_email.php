...
We need a little more information to complete your activation,including confirmation of your email address. Click below to confirm your email address: ".URL.$type."/verify_email/".$token."
...
function reset_password($data){
	...
	$comment = "
		...
		Please click the address below to reset your CFIF ONE STOP SHOP account password.
