...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?=URL_ROOT;?>admins/index" class="logo">
    ...
    <nav class="navbar navbar-static-top"  >
      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" style="color:#222;">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?=URL_ROOT;?>admins/announcements">
