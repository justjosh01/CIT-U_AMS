  ...
  <aside class="main-sidebar">
    ...
    <?=$this->view('admins/main/user_panel');?>
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?=URL_ROOT;?>super_admin/index">
            <i class="fa fa-eye"></i> <span>User Accounts</span>
        ...
        <li>
          <a href="<?=URL_ROOT;?>super_admin/admins">
            <i class="fa fa-university"></i> <span>Administrators</span>
            <span class="pull-right-container">
              <!-- <small class="label pull-right bg-green">new</small> -->
            </span>
          </a>
         ...
         <li>
          <a href="<?=URL_ROOT;?>super_admin/alumni">
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=URL_ROOT;?>"><i class="fa fa-dashboard"></i> Home</a></li>
