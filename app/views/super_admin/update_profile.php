      ...
      <div class="box box-primary">
        ...
        <form class="form-horizontal" method="post" action="" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" name="name" class="form-control" required placeholder="Full Name" value="<?=isset($data['super_admins']['name']) ? $data['super_admins']['name'] : ''; ?>" readonly>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="email" name="email" class="form-control" required placeholder="Email Address" value="<?=isset($data['super_admins']['email']) ? $data['super_admins']['email'] : ''; ?>" readonly>
